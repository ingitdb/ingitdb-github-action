...
The action.yml contains defines the inputs and output for the action.
...
After testing, we can [create a v1 tag](https://github.com/actions/toolkit/blob/master/docs/action-versioning.md) to reference the stable and latest V1 action
